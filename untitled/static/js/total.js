...
function total_comp() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            set_comp(myChart1,xtime,ytaochl,ydongchl,yshengchl,"co2");
            set_comp(myChart2,xtime,ytaotd,ydongtd,yshengtd,"硬度");
            set_comp(myChart3,xtime,ytaoph,ydongph,yshengph,"ph");
            set_comp(myChart4,xtime,ytaodo,ydongdo,yshengdo,"溶氧量");
            set_comp(myChart5,xtime,ytaowt,ydongwt,yshengwt,"水温");
            set_comp(myChart6,xtime,ytaosal,ydongsal,yshengsal,"盐度");
